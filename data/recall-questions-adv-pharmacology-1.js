export const RECALL_QUESTIONS_ADV_PHARMACOLOGY_1 = [
  ...
  // ===== ap1-wk-5 Diuretics synthesis =====

  {
    id: 'r-ap1-w5d-1',
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-what-diuretics-do', 'atom-diua-nephron-sites'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Explain what diuretics accomplish for a patient and how the loop of Henle and the concept of distinct tubular sites underlie their differing effects.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Diuretics increase urinary sodium and water loss to lower blood pressure, ease breathlessness, and reduce edema.' },
        { id: 'kp2', weight: 2, description: 'The loop of Henle is a U-shaped segment that regulates salt and water, and diuretic classes act at distinct tubular sites.' },
        { id: 'kp3', weight: 1, description: 'The site of action determines a drug\'s potency and its electrolyte fingerprint.' },
      ],
      common_errors: [
        'Treating all diuretics as acting at one site with identical effects.',
        'Attributing edema relief to oncotic or inotropic effects rather than salt and water loss.',
        'Confusing the loop of Henle with the glomerulus.',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Diuretic foundations',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Diuretic foundations', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-cai-mechanism', 'atom-diua-cai-acid-base'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Trace how acetazolamide inhibits carbonic anhydrase in the proximal tubule and how that mechanism produces its net renal and acid-base effects.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Acetazolamide inhibits carbonic anhydrase mainly in the proximal tubule, blocking carbonic acid breakdown.' },
        { id: 'kp2', weight: 2, description: 'Reabsorption of sodium, bicarbonate, and water falls, increasing bicarbonate excretion with only mild diuresis.' },
        { id: 'kp3', weight: 1, description: 'Bicarbonate wasting can cause a metabolic acidosis with alkaline urine.' },
      ],
      common_errors: [
        'Placing the action in the thick ascending limb.',
        'Predicting metabolic alkalosis rather than acidosis.',
        'Overstating the strength of the diuresis.',
      ],
      minimum_passing_score: 60,
    },
    ...
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Carbonic anhydrase inhibitors', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-acetazolamide-uses', 'atom-diua-loop-agents'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Contrast the clinical role and class identity of acetazolamide with that of the loop diuretic agents.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Acetazolamide is a carbonic anhydrase inhibitor used for glaucoma, altitude sickness, and heart failure edema, available orally and intravenously.' },
        { id: 'kp2', weight: 2, description: 'The loop class comprises furosemide, bumetanide, torsemide, and ethacrynic acid, with furosemide used for acute rapid diuresis.' },
        { id: 'kp3', weight: 1, description: 'Acetazolamide gives only mild diuresis, so loops are the choice when potent fluid removal is needed.' },
      ],
      common_errors: [
        'Listing acetazolamide as a loop diuretic.',
        'Choosing acetazolamide for rapid potent diuresis.',
        'Omitting ethacrynic acid from the loop class.',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Diuretic agents',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Diuretic agents', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-loop-mechanism', 'atom-diua-loop-potency'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Connect the loop diuretic mechanism in the thick ascending limb to why these drugs are the most potent class and first-line for fluid overload.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Loops block the sodium-potassium-two chloride cotransporter in the water-impermeable thick ascending limb.' },
        { id: 'kp2', weight: 2, description: 'Because that segment normally reclaims about 20 to 30 percent of filtered sodium, blocking it produces a large dose-dependent natriuresis.' },
        { id: 'kp3', weight: 1, description: 'This potency makes loops first-line for fluid overload in heart failure.' },
      ],
      common_errors: [
        'Naming the distal sodium-chloride cotransporter as the target.',
        'Attributing potency to whole-nephron action.',
        'Forgetting the dose-dependent natriuresis.',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Loop mechanism and potency',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Loop mechanism and potency', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-ethacrynic-acid', 'atom-diua-loop-side-effects'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Discuss why ethacrynic acid is chosen in sulfa allergy and how its adverse profile fits the broader loop diuretic side effect picture.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Ethacrynic acid is the only nonsulfonamide loop, preferred in sulfa allergy, with about 70 percent the potency of furosemide.' },
        { id: 'kp2', weight: 2, description: 'Like other loops it is dose-dependently ototoxic, and the class causes hypokalemia that raises digoxin toxicity plus hypovolemia.' },
        { id: 'kp3', weight: 1, description: 'Loops also potentiate nondepolarizing neuromuscular blockers, raise lithium and aminoglycoside levels, and reduce uric acid excretion.' },
      ],
      common_errors: [
        'Giving a sulfonamide loop to a truly sulfa-allergic patient.',
        'Expecting hyperkalemia instead of hypokalemia.',
        'Forgetting that ethacrynic acid is still ototoxic.',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Loop safety',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Loop safety', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-furosemide-pk', 'atom-diua-furosemide-dose'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Integrate furosemide pharmacokinetics with its dosing in normal versus impaired renal function and the rationale for slow administration.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Furosemide is about 90 percent protein bound with a one to two hour half-life and IV onset within 5 to 10 minutes.' },
        { id: 'kp2', weight: 2, description: '20 to 40 mg IV gives maximal natriuresis in normal kidneys, while chronic renal insufficiency needs about 160 to 200 mg IV.' },
        { id: 'kp3', weight: 1, description: 'Rapid administration risks ototoxicity and tinnitus, so larger doses are given slowly.' },
      ],
      common_errors: [
        'Using renal-failure doses in patients with normal kidneys.',
        'Stating a long half-life or oral-only availability.',
        'Pushing large doses rapidly and risking tinnitus.',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Furosemide pharmacology',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Furosemide pharmacology', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-bumetanide', 'atom-diua-torsemide'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Compare bumetanide and torsemide in potency, routes, and elimination relative to furosemide.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Bumetanide is about 40 times more potent than furosemide with 80 to 100 percent oral bioavailability and oral, intravenous, and intramuscular routes.' },
        { id: 'kp2', weight: 2, description: 'Torsemide is about 3 times more potent than furosemide with a 3 to 4 hour half-life and once-daily dosing.' },
        { id: 'kp3', weight: 1, description: 'Torsemide is primarily hepatically metabolized, and liver failure increases renal drug delivery.' },
      ],
      common_errors: [
        'Reversing the relative potencies of bumetanide and torsemide.',
        'Saying torsemide is mainly renally eliminated.',
        'Believing bumetanide lacks an oral formulation.',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Loop agent comparison',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Loop agent comparison', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-loop-hypertension', 'atom-diua-loop-heart-failure'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Explain how loop diuretics are applied in hypertension and in acute decompensated heart failure, including their mechanisms in each setting.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'In hypertension loops lower blood pressure by reducing intravascular volume and sodium retention and are first-line in renal insufficiency.' },
        { id: 'kp2', weight: 2, description: 'In acute decompensated heart failure they are first-line, lowering filling pressure and pulmonary edema via diuresis and prostaglandin-mediated venodilation.' },
        { id: 'kp3', weight: 1, description: 'Torsemide has been associated with fewer heart failure readmissions than furosemide.' },
      ],
      common_errors: [
        'Calling loops first-line for uncomplicated hypertension with normal kidneys.',
        'Saying loops constrict veins instead of dilating them.',
        'Forgetting the renal insufficiency indication.',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Loop cardiovascular uses',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Loop cardiovascular uses', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diua-loop-icp', 'atom-diua-loop-hypercalcemia'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Describe the neurologic and metabolic uses of furosemide, covering intracranial pressure control and management of hypercalcemia.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Furosemide 0.5 to 1 mg/kg IV lowers intracranial pressure via systemic diuresis and reduced cerebrospinal fluid production and can be added to mannitol.' },
        { id: 'kp2', weight: 2, description: 'Unlike mannitol with a disrupted blood-brain barrier, furosemide causes no rebound intracranial pressure.' },
        { id: 'kp3', weight: 1, description: 'Loops promote urinary calcium excretion and help treat symptomatic hypercalcemia, opposite to calcium-retaining thiazides.' },
      ],
      common_errors: [
        'Claiming furosemide causes rebound intracranial pressure.',
        'Confusing the calciuric effect of loops with the calcium retention of thiazides.',
        'Forgetting the dehydration risk when combining furosemide with mannitol.',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Loop neuro and metabolic uses',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Loop neuro and metabolic uses', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diub-thiazide-dct', 'atom-diub-thiazide-calcium'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Explain how the distal convoluted tubule site of thiazide action accounts for both the potassium loss and the calcium retention seen with these drugs.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Thiazides block the sodium chloride cotransporter in the distal convoluted tubule, increasing sodium delivery downstream.' },
        { id: 'kp2', weight: 2, description: 'Greater sodium delivery to the collecting duct drives potassium secretion and hypokalemia.' },
        { id: 'kp3', weight: 1, description: 'The same distal site enhances calcium reabsorption, raising serum calcium and helping prevent calcium stones.' },
      ],
      common_errors: [
        'Placing thiazide action at the thick ascending limb',
        'Saying thiazides increase urinary calcium like loops',
        'Claiming thiazides spare potassium',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Thiazide site and electrolyte effects',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Thiazide site and electrolyte effects', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diub-thiazide-firstline', 'atom-diub-thiazide-h'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Justify thiazides as first-line chronic antihypertensives while accounting for the metabolic and perioperative risks an anesthetist must anticipate.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'They lower blood pressure first by reducing extracellular volume and then by sustained reduction of systemic vascular resistance.' },
        { id: 'kp2', weight: 2, description: 'Their H side effects include hypokalemia, hypomagnesemia, hyperglycemia, hyperuricemia, and metabolic alkalosis.' },
        { id: 'kp3', weight: 1, description: 'They potentiate nondepolarizing blockers and reduce lithium clearance, raising perioperative concern.' },
      ],
      common_errors: [
        'Saying the chronic effect is mainly ongoing volume loss',
        'Listing hyperkalemia as a thiazide effect',
        'Forgetting the potentiation of muscle relaxants',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Thiazide use and risks',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Thiazide use and risks', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diub-thiazide-uses', 'atom-diub-hctz-pk'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Compare hydrochlorothiazide, chlorthalidone, and metolazone in terms of duration and the clinical scenarios that favor each.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Hydrochlorothiazide lasts about 8 to 12 hours while chlorthalidone lasts roughly 50 to 60 hours, favoring chlorthalidone in resistant hypertension.' },
        { id: 'kp2', weight: 2, description: 'Metolazone is added to a loop diuretic for sequential nephron blockade when a loop alone fails in renal insufficiency.' },
        { id: 'kp3', weight: 1, description: 'Most thiazides are renally cleared and lose efficacy in renal insufficiency, with indapamide the hepatic exception.' },
      ],
      common_errors: [
        'Treating hydrochlorothiazide and chlorthalidone as interchangeable in duration',
        'Pairing spironolactone instead of metolazone with a loop',
        'Saying thiazides remain fully effective in renal insufficiency',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Thiazide agents and pharmacokinetics',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Thiazide agents and pharmacokinetics', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diub-osmotic-mech', 'atom-diub-mannitol-systemic'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Trace how the filtered nonreabsorbed nature of mannitol explains both its tubular osmotic diuresis and its systemic water-shifting effects.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Being freely filtered and not reabsorbed, mannitol raises tubular fluid osmolality and holds water in water-permeable segments, causing osmotic diuresis.' },
        { id: 'kp2', weight: 2, description: 'In plasma it raises osmolality and pulls water from the intracellular into the intravascular space.' },
        { id: 'kp3', weight: 1, description: 'This intravascular water shift reduces intracranial pressure, and mannitol also scavenges free radicals.' },
      ],
      common_errors: [
        'Saying mannitol blocks a sodium transporter',
        'Claiming it draws water into cells rather than out',
        'Forgetting it must be filtered to produce diuresis',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Osmotic mechanism and mannitol effects',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Osmotic mechanism and mannitol effects', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diub-mannitol-icp', 'atom-diub-mannitol-side'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Discuss the safe use of mannitol for raised intracranial pressure, including the two scenarios in which it becomes harmful.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'With an intact blood-brain barrier mannitol draws water out of the brain and lowers intracranial pressure within minutes.' },
        { id: 'kp2', weight: 2, description: 'A disrupted barrier lets mannitol enter brain tissue and cause rebound intracranial hypertension.' },
        { id: 'kp3', weight: 1, description: 'Early intravascular expansion threatens patients with left ventricular dysfunction, and in renal failure it accumulates because it is not filtered.' },
      ],
      common_errors: [
        'Saying mannitol helps regardless of barrier integrity',
        'Recommending mannitol diuresis in renal failure',
        'Ignoring the pulmonary edema risk in heart failure',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Mannitol ICP use and hazards',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Mannitol ICP use and hazards', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diub-enac', 'atom-diub-ksparing-role'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Explain how the epithelial sodium channel blockers spare potassium and why the small sodium load of their site dictates how they are used clinically.',
    rubric: {
      key_points: [
        ...
        { id: 'kp2', weight: 2, description: 'The collecting duct reclaims only a small fraction of filtered sodium, so the resulting diuresis is mild.' },
        { id: 'kp3', weight: 1, description: 'They are therefore added to kaliuretic loops or thiazides to prevent hypokalemia rather than used as primary antihypertensives.' },
      ],
      common_errors: [
        'Calling amiloride an aldosterone antagonist',
        'Saying these collecting-duct agents give potent diuresis',
        'Using potassium-sparing agents mainly as standalone antihypertensives',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Potassium-sparing mechanism and role',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Potassium-sparing mechanism and role', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diub-aldo-uses', 'atom-diub-aldo-side'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Build the case for aldosterone antagonists in heart failure while explaining the single greatest safety concern before anesthesia.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'They reduce mortality in heart failure with reduced ejection fraction, supported by RALES, and eplerenone improves post-infarction survival.' },
        { id: 'kp2', weight: 2, description: 'Hyperkalemia is the most serious effect, worsened by ACE inhibitors or ARBs and renal impairment, so potassium must be checked preoperatively.' },
        { id: 'kp3', weight: 1, description: 'Spironolactone additionally causes gynecomastia, an effect the selective eplerenone largely avoids.' },
      ],
      common_errors: [
        'Crediting the heart failure benefit to a trial other than RALES',
        'Listing hypokalemia rather than hyperkalemia as the danger',
        'Attributing gynecomastia to eplerenone',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Aldosterone antagonist benefit and safety',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Aldosterone antagonist benefit and safety', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diub-aldo-mech', 'atom-diub-tolvaptan'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Distinguish how an aldosterone antagonist and tolvaptan each alter collecting-duct function and the contrasting electrolyte and safety consequences.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Aldosterone antagonists block the mineralocorticoid receptor to spare potassium while reducing sodium reabsorption.' },
        { id: 'kp2', weight: 2, description: 'Tolvaptan blocks the V2 receptor and aquaporin-2 insertion, producing aquaresis of dilute urine while preserving sodium and potassium.' },
        { id: 'kp3', weight: 1, description: 'Aldosterone antagonists risk hyperkalemia, whereas tolvaptan risks osmotic demyelination from rapid sodium correction.' },
      ],
      common_errors: [
        'Saying tolvaptan wastes sodium and potassium',
        'Confusing aquaresis with natriuretic diuresis',
        'Forgetting the demyelination warning with tolvaptan',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Collecting-duct receptor antagonists contrasted',
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Collecting-duct receptor antagonists contrasted', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diuc-dopamine-dose', 'atom-diuc-fenoldopam'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Compare dopamine across its dose range with fenoldopam, explaining why fenoldopam lowers blood pressure without tachycardia while dopamine can raise pressure and heart rate.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Dopamine shifts from D1 vasodilation at low dose to beta1 inotropy at moderate dose to alpha1 vasoconstriction at high dose' },
        { id: 'kp2', weight: 2, description: 'Fenoldopam is a pure D1 agonist with no beta or alpha activity, so it drops SVR without driving heart rate' },
        { id: 'kp3', weight: 1, description: 'Fenoldopam has a short half-life near 10 minutes and is IV only, suiting titrated hypertension control' },
      ],
      common_errors: [
        'Expecting fenoldopam to cause beta1 tachycardia like moderate-dose dopamine',
        'Assuming dopamine remains a pure renal vasodilator at every dose',
        'Giving fenoldopam orally for chronic blood pressure control',
      ],
      minimum_passing_score: 60,
    },
    ...
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Dopamine agonists', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diuc-nak-link', 'atom-diuc-universal-rule'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Using the distal sodium-potassium link, explain why upstream diuretics produce low potassium with alkalosis while collecting duct agents produce high potassium with acidosis.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Upstream sodium blockade increases distal sodium delivery, and sodium uptake creates a lumen-negative voltage that drives potassium and hydrogen secretion' },
        { id: 'kp2', weight: 2, description: 'So upstream agents lower potassium with metabolic alkalosis, matching the universal site rule' },
        { id: 'kp3', weight: 1, description: 'Collecting duct agents block that distal sodium uptake, retaining potassium and hydrogen, giving hyperkalemia with acidosis' },
      ],
      common_errors: [
        'Reversing which site lowers versus raises potassium',
        'Forgetting that the lumen-negative voltage also drives hydrogen loss and alkalosis',
        'Treating the electrolyte fingerprint as unrelated to the site of action',
      ],
      minimum_passing_score: 60,
    },
    ...
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Electrolyte effects', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diuc-periop-volume', 'atom-diuc-periop-watch'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'A chronic diuretic user presents for major surgery. Integrate the expected volume trajectory with the key perioperative interaction risks to outline a safe plan.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Anticipate relative preoperative volume depletion followed by stress-driven postoperative fluid retention, balancing edema control against hypovolemia and renal hypoperfusion' },
        { id: 'kp2', weight: 2, description: 'Check and correct potassium and magnesium, replacing magnesium first for refractory hypokalemia, given digoxin and dysrhythmia risk' },
        { id: 'kp3', weight: 1, description: 'Account for potentiation of nondepolarizing NMB, reduced lithium clearance, sulfa allergy favoring ethacrynic acid, and avoidance of mannitol in renal failure' },
      ],
      common_errors: [
        'Assuming the patient is volume overloaded preoperatively and diuresing hard',
        'Replacing potassium without correcting magnesium',
        'Overlooking prolonged neuromuscular blockade and rising lithium levels',
      ],
      minimum_passing_score: 60,
    },
    ...
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Perioperative diuretics', ladder_tier_appropriate: 'pre-induction' },
  },

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diuc-d1-site', 'atom-diuc-lowdose-outcome'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Reconcile the favorable renal mechanism of low-dose dopamine with the recommendation against using it for renal protection.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'D1 stimulation in the proximal tubule and loop of Henle does produce natriuresis, higher renal blood flow, and a mild rise in GFR' },
        { id: 'kp2', weight: 2, description: 'Despite that mechanism, controlled evidence shows clinical outcomes are not improved by low-dose dopamine' },
        { id: 'kp3', weight: 1, description: 'Increased urine output is not the same as preserved renal function, so the agent is not recommended for renal protection' },
      ],
      common_errors: [
        'Assuming the plausible mechanism guarantees a clinical benefit',
        'Reading higher urine output as evidence of protected kidneys',
        'Continuing to recommend low-dose dopamine for renal protection',
      ],
      minimum_passing_score: 60,
    },
    topic: 'Dopamine agonists',
...

  {
    ...
    type: 'recall',
    tier: 'synthesis',
    feeder_atoms: ['atom-diuc-agonist-uses', 'atom-diuc-class-site'],
    courseId: 'adv-pharmacology-1',
    nodeId: 'ap1-wk-5',
    prompt: 'Explain how knowing a drug\'s site or receptor of action guides its appropriate use, contrasting the dopamine agonists with the six diuretic classes.',
    rubric: {
      key_points: [
        { id: 'kp1', weight: 2, description: 'Dopamine supports low or normal SVR shock and fenoldopam treats severe hypertension without tachycardia, and neither is supported for routine renal protection' },
        { id: 'kp2', weight: 2, description: 'The six diuretic classes map to distinct segments from proximal tubule through thick ascending limb, distal convoluted tubule, and collecting duct' },
        { id: 'kp3', weight: 1, description: 'Matching the segment or receptor to the clinical goal predicts both the intended effect and the expected adverse profile' },
      ],
      common_errors: [
        'Using a dopamine agonist as routine renal protection',
        'Confusing the tubule segment that a given class targets',
        'Selecting an agent without linking its site to the clinical goal',
      ],
      minimum_passing_score: 60,
    },
    ...
    chapter: 'ap1-wk-5',
    difficulty: 2,
    metadata: { priority: 'high', source: 'Stoelting Ch 22; Whybrew lecture', topic: 'Diuretic sites', ladder_tier_appropriate: 'pre-induction' },
  },
