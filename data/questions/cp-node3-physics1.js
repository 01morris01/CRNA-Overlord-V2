...
export const CP_NODE3_QUESTIONS = [
...

  {
    id: "cp-n3-010",
    type: "mcq",
    prompt: "A gauge on an oxygen E-cylinder reads 900 PSI. This is gauge pressure, which starts at zero. What is the corresponding absolute pressure?",
    setup: "",
    ans: [
      { t: "Approximately 914.7 PSI — gauge pressure plus atmospheric pressure (900 + 14.7)",             ok: true  },
      { t: "Approximately 885.3 PSI — gauge pressure minus atmospheric pressure (900 − 14.7)",            ok: false },
      { t: "Exactly 900 PSI — gauge and absolute pressure are the same for compressed gas cylinders",      ok: false },
      { t: "Approximately 1,660 PSI — gauge pressure plus 760 mmHg converted directly to PSI",            ok: false },
    ],
    rationale: "Gauge pressure reads zero at atmospheric pressure. Absolute pressure = gauge pressure + atmospheric pressure. Atmospheric pressure ≈ 14.7 PSI, so absolute = 900 + 14.7 = 914.7 PSI. In clinical practice the difference is small for high-pressure cylinders, but the concept matters for low-pressure systems and gas law calculations that require absolute pressure.",
    scene: "gas_piston",
...

  {
    id: "cp-n3-014",
    type: "mcq",
    prompt: "A ventilator displays airway pressure as 20 cmH₂O. What is this pressure approximately in mmHg?",
    setup: "1 mmHg ≈ 1.36 cmH₂O.",
    ans: [
      { t: "Approximately 14.7 mmHg — dividing 20 cmH₂O by the conversion factor of 1.36", ok: true  },
      { t: "Approximately 27.2 mmHg — multiplying 20 cmH₂O by the conversion factor 1.36", ok: false },
      { t: "Approximately 20.0 mmHg — cmH₂O and mmHg are numerically identical unit values", ok: false },
      { t: "Approximately 7.4 mmHg — dividing 20 cmH₂O by the density ratio of mercury 2.7", ok: false },
    ],
    rationale: "Mercury is 13.6 times denser than water, so 1 mmHg = 1.36 cmH₂O. To convert cmH₂O to mmHg, divide by 1.36: 20 / 1.36 ≈ 14.7 mmHg. This conversion is essential when comparing ventilator pressures (usually in cmH₂O) with hemodynamic pressures (usually in mmHg).",
    scene: null,
    sceneCfg: {},
    metadata: { topic: "Pressure Units", priority: "high" },
  },
...

  {
    id: "cp-n3-017",
    type: "mcq",
    prompt: "Momentum is defined as mass times velocity (p = mv). A 100 kg patient on a stretcher rolling at 1 m/s has what momentum, and what does this mean clinically?",
    setup: "",
    ans: [
      { t: "100 kg·m/s — more force or time is needed to stop the heavier, faster-moving stretcher safely", ok: true  },
      { t: "10 kg·m/s — momentum is calculated by dividing mass by velocity for objects on a flat surface",  ok: false },
      { t: "100 N — momentum is the same as force and is measured in newtons by Newton's second law",        ok: false },
      { t: "9.8 kg·m/s — gravitational acceleration must be included in the momentum calculation formula",   ok: false },
    ],
    rationale: "Momentum p = mv = 100 kg × 1 m/s = 100 kg·m/s. Stopping requires an impulse (force × time) equal to this momentum. A heavier patient on a rolling stretcher has greater momentum and needs more braking force or distance to stop safely. This is Newton's second law in impulse form: F·Δt = Δp.",
    scene: null,
    sceneCfg: {},
