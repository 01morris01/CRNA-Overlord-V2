...
export const AP1_WK2_QUESTIONS = [
...

  {
    ...
    setup: "",
    ans: [
      { t: "General inhalation anesthesia", ok: false },
      { t: "Regional anesthesia, peripheral nerve blocks, and neuraxial techniques", ok: true },
      { t: "Total intravenous anesthesia with propofol", ok: false },
      { t: "Monitored anesthesia care with sedation only", ok: false },
    ],
...

  {
    ...
    ans: [
      ...
      { t: "Involuntary visceral functions and physiologic homeostasis", ok: true },
      { t: "Conscious sensory perception", ok: false },
...

  {
    ...
    ans: [
      ...
      { t: "Bronchodilation", ok: false },
      { t: "Increased gastrointestinal motility and secretions", ok: true },
      { t: "Increased blood pressure", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Increased heart rate and bronchodilation", ok: false },
      { t: "Decreased heart rate, increased GI motility, and bronchoconstriction", ok: true },
      { t: "Pupil dilation and increased blood pressure", ok: false },
...

  {
    ...
    ans: [
      ...
      { t: "Conversion to a false neurotransmitter (alpha methylnorepinephrine) that reduces central sympathetic outflow", ok: true },
      { t: "Inhibition of acetylcholinesterase", ok: false },
      { t: "Stimulation of beta 2 receptors causing vasodilation", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Directly stimulating adrenergic receptors", ok: false },
      { t: "Blocking norepinephrine reuptake at the synapse", ok: true },
      { t: "Inhibiting monoamine oxidase", ok: false },
      { t: "Releasing epinephrine from the adrenal medulla", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Active only during stress or sleep", ok: false },
      { t: "Continuously active at a baseline level", ok: true },
      { t: "Completely silent at rest and activated only by stimulation", ok: false },
      { t: "Active in alternating cycles of 24 hours", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Greater HRV generally indicates healthy parasympathetic activity", ok: true },
      { t: "Greater HRV indicates sympathetic dominance", ok: false },
      { t: "Low HRV indicates optimal vagal tone", ok: false },
      { t: "HRV measures catecholamine levels directly", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Single random plasma catecholamine level", ok: false },
      { t: "24 hour urine catecholamine and metanephrine testing", ok: true },
      { t: "Heart rate variability analysis", ok: false },
      { t: "Plasma cortisol level", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Gastroparesis", ok: false },
      { t: "Postural (orthostatic) hypotension", ok: false },
      { t: "Sweating abnormalities", ok: false },
      { t: "Exaggerated compensatory hypertensive response to blood loss", ok: true },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Decreased receptor number and diminished responses to neurotransmitters", ok: false },
      { t: "Receptor upregulation and exaggerated responses to circulating catecholamines", ok: true },
      { t: "Complete loss of tissue responsiveness to all drugs", ok: false },
      { t: "Compensatory parasympathetic innervation of the affected tissue", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Beta blockade initiated first, followed by alpha blockade", ok: false },
      { t: "Alpha and beta adrenergic blockade", ok: true },
      { t: "Cholinesterase inhibitors only", ok: false },
      { t: "Calcium channel blockers exclusively", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Excessive catecholamine production", ok: false },
      { t: "Decreased responsiveness to catecholamines and reduced autonomic reserve", ok: true },
      { t: "Enhanced parasympathetic tone", ok: false },
      { t: "Increased adrenal medullary mass", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Its chromaffin cells receive preganglionic sympathetic fibers and release catecholamines directly into the bloodstream", ok: true },
      { t: "It produces cortisol in response to ACTH", ok: false },
      { t: "It receives parasympathetic innervation from the vagus nerve", ok: false },
      { t: "It secretes acetylcholine as its primary hormone", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Increasing PNMT enzyme activity", ok: true },
      { t: "Directly stimulating nicotinic receptors on chromaffin cells", ok: false },
      { t: "Blocking norepinephrine reuptake in the adrenal gland", ok: false },
      { t: "Inhibiting monoamine oxidase in the adrenal medulla", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Muscarinic receptors on chromaffin cells", ok: false },
      { t: "Beta adrenergic receptors on chromaffin cells", ok: false },
      { t: "Nicotinic receptors on chromaffin cells, causing calcium influx and exocytosis", ok: true },
      { t: "GABA receptors on chromaffin cells", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Stronger cardiac stimulation and skeletal muscle vasodilation at low doses via beta 2 receptors", ok: true },
      { t: "More potent vasoconstriction with no cardiac effects", ok: false },
      { t: "Exclusively alpha adrenergic mediated responses", ok: false },
      { t: "Longer duration of action than norepinephrine", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "White adipose tissue via lipolysis", ok: false },
      { t: "Brown adipose tissue via uncoupling protein 1 (UCP 1)", ok: true },
      { t: "Skeletal muscle via repeated contraction", ok: false },
      { t: "The liver via gluconeogenesis", ok: false },
    ],
...

  {
    ...
    ans: [
      ...
      { t: "Core temperature without increasing metabolic rate", ok: false },
      { t: "Vasodilation and heat loss", ok: false },
      { t: "Parasympathetic activity exclusively", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "The patient's body temperature remains constant regardless of environment", ok: false },
      { t: "The patient loses normal temperature regulation and body temperature drifts toward the ambient temperature", ok: true },
      { t: "The patient's core temperature is actively raised by anesthetic drugs", ok: false },
      { t: "The patient generates excessive metabolic heat during surgery", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Enhanced to compensate for heat loss", ok: false },
      { t: "Unaffected by anesthetic agents", ok: false },
      { t: "Absent", ok: true },
      { t: "The primary mechanism preventing hypothermia", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Core temperature drop of 0.5°C to 1.5°C due to vasodilation redistributing heat from core to periphery", ok: true },
      { t: "Core temperature drop of 4°C to 5°C due to metabolic failure", ok: false },
      { t: "Core temperature increase from surgical stimulation", ok: false },
      { t: "Stable core temperature with peripheral warming", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Complete metabolic shutdown", ok: false },
      { t: "Thermoregulatory vasoconstriction that preserves core temperature by reducing heat loss to the periphery", ok: true },
      { t: "Maximal shivering that generates enough heat to stop further cooling", ok: false },
      { t: "External rewarming by the surgical team", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Blocks sympathetic vasoconstriction below the level of the block and may impair the shivering response", ok: true },
      { t: "Directly stimulates brown fat thermogenesis", ok: false },
      { t: "Increases metabolic rate in the blocked segments", ok: false },
...

  {
    ...
    setup: "",
    ans: [
      { t: "Cool operating room environment", ok: false },
      { t: "Administration of unwarmed intravenous fluids", ok: false },
      { t: "Drug induced vasodilation", ok: false },
      { t: "Preoperative forced air warming of the patient", ok: true },
    ],
