...
export const CP_NODE7_QUESTIONS = [
...

  {
    id: "cp-n7-019",
    type: "mcq",
    prompt: "What is the difference between relative humidity and absolute humidity?",
    setup: "",
    ans: [
      { t: "Relative humidity is the percentage of maximum water vapor capacity at a given temperature; absolute humidity is the actual mass of water per volume of gas", ok: true  },
      { t: "Relative humidity measures water content in mg/L while absolute humidity is the percentage of saturation at a given temperature and barometric pressure",     ok: false },
      { t: "They are identical measurements expressed in different units — both describe the same physical quantity of moisture in the inspired gas mixture",             ok: false },
      { t: "Relative humidity applies only to ambient room air while absolute humidity applies only to gases delivered through the anesthesia breathing circuit",         ok: false },
    ],
    rationale: "Relative humidity (RH) is the ratio of actual water vapor pressure to the saturated vapor pressure at that temperature, expressed as a percentage. It is temperature-dependent — the same absolute moisture content gives a different RH at different temperatures. Absolute humidity is the actual mass of water vapor per unit volume of gas (mg H₂O/L), independent of temperature. In anesthesia, inadequately humidified gas desiccates airway mucosa, impairs mucociliary clearance, and increases secretion viscosity.",
    scene: null,
    sceneCfg: {},
