...
export const PP2_WK5_QUESTIONS = [
  ...
  // ── pp2-w5-001 ── Fick's Law of Diffusion ──────────────────────────────────
  {
    ...
    ans: [
      ...
      { t: "Total surface area available across the whole membrane", ok: false },
      { t: "Molecular weight of the diffusing gas in the alveolus", ok: false },
      { t: "Overall thickness of the alveolar respiratory membrane", ok: false },
    ],
  ...
  // ── pp2-w5-002 ── Respiratory Membrane Thickness ───────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Diffusion rate is halved", ok: true },
      { t: "Diffusion rate is quartered", ok: false },
      { t: "Diffusion rate is unchanged", ok: false },
      { t: "Diffusion rate increases", ok: false },
    ],
  ...
  // ── pp2-w5-003 ── CO2 vs O2 Diffusion ─────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "CO2 is far more soluble in the membrane, and D scales with solubility", ok: true },
      { t: "CO2 has a lower molecular weight than O2, raising its diffusion rate", ok: false },
      { t: "The partial pressure gradient for CO2 is 20 times larger than for O2", ok: false },
      { t: "CO2 is actively pumped across by carbonic anhydrase in type I cells", ok: false },
    ],
  ...
  // ── pp2-w5-004 ── Oxygen-Hemoglobin Dissociation Curve Shape ───────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Cooperative binding; one bound O2 raises affinity of the other subunits", ok: true },
      { t: "Competitive inhibition; CO2 and O2 vie for one shared binding site", ok: false },
      { t: "Saturation kinetics; a single O2 site saturates as PO2 climbs higher", ok: false },
      { t: "Allosteric block by 2,3-DPG that is relieved only at high PO2 values", ok: false },
    ],
  ...
  // ── pp2-w5-005 ── P50 ─────────────────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "PO2 at 50% saturation; a higher P50 means lower affinity and easier unloading", ok: true },
      { t: "PO2 at 50% saturation; a higher P50 means higher affinity and tighter binding", ok: false },
      { t: "PO2 needed to fully saturate Hgb; a higher P50 means more O2 for saturation", ok: false },
      { t: "PO2 of plasma-dissolved O2 at 50%; it reflects Henry's law, not Hgb affinity", ok: false },
    ],
  ...
  // ── pp2-w5-006 ── Bohr Effect ─────────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Acidosis right-shifts the curve, lowers O2 affinity, and boosts tissue unloading", ok: true },
      { t: "Acidosis left-shifts the curve, raises O2 affinity, and impairs tissue unloading", ok: false },
      { t: "Acidosis does not move the curve at all; only temperature shifts the curve", ok: false },
      { t: "Acidosis cuts dissolved O2 by Henry's law, lowering total tissue O2 delivery", ok: false },
    ],
  ...
  // ── pp2-w5-007 ── 2,3-DPG ────────────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Left-shifted curve with impaired tissue O2 unloading", ok: true },
      { t: "Right-shifted curve with enhanced tissue O2 unloading", ok: false },
      { t: "No curve change with normal tissue O2 unloading", ok: false },
      { t: "Reduced O2-carrying capacity with normal unloading", ok: false },
    ],
  ...
  // ── pp2-w5-008 ── Carbon Monoxide ─────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Two-wavelength oximeters cannot separate COHgb from OxyHgb at 660 nm", ok: true },
      { t: "CO raises O2 binding to Hgb, so the SpO2 reflects true O2 saturation", ok: false },
      { t: "The high PaO2 proves tissue oxygenation is fine and the SpO2 is right", ok: false },
      { t: "Oximeters read dissolved O2 by Henry's law, which CO does not affect", ok: false },
    ],
  ...
  // ── pp2-w5-009 ── Fetal Hemoglobin ────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Gamma chains bind 2,3-DPG poorly, raising affinity to pull O2 from mother", ok: true },
      { t: "A unique heme binds O2 irreversibly, so the fetus always stays oxygenated", ok: false },
      { t: "Epsilon chains replace alpha chains and carry a higher intrinsic affinity", ok: false },
      { t: "Same structure as adult Hgb but fetal low pH drives the leftward shift", ok: false },
    ],
  ...
  // ── pp2-w5-010 ── Temperature Shift ───────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Curve left-shifts and affinity rises; less unloading, but demand falls too", ok: true },
      { t: "Curve right-shifts and affinity falls, boosting O2 to cold-injured tissue", ok: false },
      { t: "Cold barely moves the curve; only pH and 2,3-DPG matter at the bedside", ok: false },
      { t: "Curve left-shifts while demand climbs, making a supply-demand mismatch", ok: false },
    ],
  ...
  // ── pp2-w5-011 ── Henry's Law / Dissolved O2 ─────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "0.3 mL O2/dL", ok: true },
      { t: "3.0 mL O2/dL", ok: false },
      { t: "20 mL O2/dL", ok: false },
      { t: "1.34 mL O2/dL", ok: false },
    ],
  ...
  // ── pp2-w5-012 ── O2 Content Equation ─────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "13.4 mL/dL: (1.34 x 10 x 0.98) + (0.003 x 90) = 13.13 + 0.27", ok: true },
      { t: "20.1 mL/dL: this value would instead require a Hgb of 15 g/dL", ok: false },
      { t: "9.0 mL/dL: this wrongly drops the entire Hgb-bound component", ok: false },
      { t: "0.27 mL/dL: this counts only the dissolved O2 component alone", ok: false },
    ],
  ...
  // ── pp2-w5-013 ── DO2 Oxygen Delivery ─────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "670 mL/min (CO x CaO2 x 10); below the normal 1000, so delivery is reduced", ok: true },
      { t: "67 mL/min; this drops the factor-of-10 dL-to-L unit conversion step", ok: false },
      { t: "1340 mL/min; this wrongly doubles the patient's measured cardiac output", ok: false },
      { t: "1000 mL/min; counted as normal since cardiac output offsets the anemia", ok: false },
    ],
  ...
  // ── pp2-w5-014 ── CO2 Transport Mechanisms ────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Bicarbonate; about 70% is converted to HCO3 by carbonic anhydrase in RBCs", ok: true },
      { t: "Carbaminohemoglobin; CO2 on the terminal amino groups of Hgb, near 20%", ok: false },
      { t: "Dissolved CO2 in plasma; roughly 7 to 10%, set by Henry's law solubility", ok: false },
      { t: "Carbonic acid; the brief intermediate form present before it dissociates", ok: false },
    ],
  ...
  // ── pp2-w5-015 ── Haldane Effect ──────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Oxygenation lowers Hgb affinity for CO2 and H+, so the lungs release CO2", ok: true },
      { t: "Tissue CO2 lowers Hgb O2 affinity to aid unloading; that is the Bohr effect", ok: false },
      { t: "Hemoglobin buffers CO2 by turning it into bicarbonate within the plasma", ok: false },
      { t: "O2 and CO2 share the heme iron site, and O2 displaces CO2 within the lungs", ok: false },
    ],
  ...
  // ── pp2-w5-016 ── Chloride Shift ──────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "HCO3 leaves via band 3 in exchange for Cl, keeping the cell electroneutral", ok: true },
      { t: "Cl leaves in exchange for HCO3 entering, acidifying plasma to free up O2", ok: false },
      { t: "Na enters with HCO3 to preserve osmotic balance during the CO2 loading", ok: false },
      { t: "K leaves the cell as CO2 enters, which prevents intracellular acidosis", ok: false },
    ],
  ...
  // ── pp2-w5-017 ── A-a Gradient ────────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "28 mmHg; PAO2 = 0.21(713) minus 40/0.8 = 99.7, then 99.7 minus 72", ok: true },
      { t: "8 mmHg; this wrongly assumes the PAO2 equals 80 mmHg in this patient", ok: false },
      { t: "50 mmHg; this uses the PaCO2 value directly without dividing it by RQ", ok: false },
      { t: "0 mmHg; this assumes PAO2 should equal PaO2 in any healthy patient", ok: false },
    ],
  ...
  // ── pp2-w5-018 ── Alveolar Gas Equation ───────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "About 384 mmHg: 0.60 x (760 minus 47) minus 35/0.8 = 427.8 minus 43.75", ok: true },
      { t: "About 456 mmHg: this version omits the PaCO2 over RQ correction term", ok: false },
      { t: "About 149 mmHg: this uses an FiO2 of 0.21 instead of the value 0.60", ok: false },
      { t: "About 300 mmHg: this applies an RQ of 1.0 in place of the value 0.8", ok: false },
    ],
  ...
  // ── pp2-w5-019 ── Multi-Select: Right Shift Factors ──────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Decreased pH (acidosis)", ok: true },
      { t: "Increased temperature", ok: true },
      { t: "Increased 2,3-DPG", ok: true },
      { t: "Increased PaCO2", ok: true },
      { t: "Carbon monoxide binding", ok: false },
      { t: "Fetal hemoglobin (HgbF)", ok: false },
      { t: "Hypothermia", ok: false },
      { t: "Increased pH (alkalosis)", ok: false },
    ],
  ...
  // ── pp2-w5-021 ── Multi-Select: Diffusion Impairment ─────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Pulmonary fibrosis", ok: true },
      { t: "Emphysema", ok: true },
      { t: "Pulmonary edema", ok: true },
      { t: "Pneumonectomy", ok: true },
      { t: "Anemia", ok: false },
  ...
  // ── pp2-w5-022 ── Multi-Select: Oxygen Cascade ───────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Atmospheric (dry inspired) PO2 ≈ 159 mmHg", ok: true },
      { t: "Humidified tracheal PO2 ≈ 149 mmHg", ok: true },
      { t: "Alveolar PO2 (PAO2) ≈ 100 mmHg", ok: true },
      { t: "Arterial PO2 (PaO2) ≈ 95 to 100 mmHg", ok: true },
      { t: "Mitochondrial PO2 ≈ 40 mmHg", ok: false },
      { t: "Alveolar PO2 ≈ 159 mmHg", ok: false },
    ],
