...
export const PP2_WK5_QUESTIONS = [
  ...
  // ── pp2-w5-002 ── Respiratory Membrane Thickness ───────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Diffusion rate is halved; rate is inversely proportional to thickness", ok: true },
      { t: "Diffusion rate is quartered because the thickness relation is squared", ok: false },
      { t: "Diffusion rate is unchanged; the PO2 gradient compensates on its own", ok: false },
      { t: "Diffusion rate rises because edema fluid acts as a gas-transfer solvent", ok: false },
    ],
  ...
  // ── pp2-w5-007 ── 2,3-DPG ────────────────────────────────────────────────
  {
    ...
    setup: "",
    ans: [
      { t: "Left-shifted curve with impaired tissue unloading despite adequate Hgb and SaO2", ok: true },
      { t: "Right-shifted curve with enhanced unloading that improves tissue oxygenation", ok: false },
      { t: "No curve change because 2,3-DPG is regenerated instantly once transfused", ok: false },
      { t: "Lower O2-carrying capacity from hemoglobin denaturation in the stored blood", ok: false },
    ],
