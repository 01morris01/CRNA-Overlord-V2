...
export const PATHO_NODE7_QUESTIONS = [

  {
    ...
    setup: "",
    ans: [
      { t: "First-degree AV block",       ok: true  },
      { t: "Second-degree Mobitz type I (Wenckebach)", ok: false },
      { t: "Second-degree Mobitz type II",   ok: false },
      { t: "Third-degree (complete) heart block", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Systemic veins and venules (~60% of total blood volume)", ok: true  },
      { t: "Systemic arteries (~15%)",                                 ok: false },
      { t: "Pulmonary circulation (~9%)",                              ok: false },
      { t: "Capillaries (~5%)",                                        ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Capillaries — huge aggregate area → slowest linear velocity → maximal time for diffusion", ok: true  },
      { t: "Aorta — largest single vessel → fastest velocity",                                          ok: false },
      { t: "Arterioles — greatest resistance → slowest velocity",                                        ok: false },
      { t: "Venae cavae — draining all blood → slowest velocity",                                        ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Arterioles",  ok: true  },
      { t: "Capillaries", ok: false },
      { t: "Large veins", ok: false },
      { t: "Aorta",       ok: false },
    ],
...

  {
    ...
    setup: "",
    choices: [
      "High compliance (large volume change for small pressure change)",
      "Serve as the body's main blood volume reservoir",
      "Thinner walls relative to lumen diameter",
      "Greater systemic vascular resistance contribution",
      "Higher elastic recoil pressure",
    ],
    correctAnswers: [
      "High compliance (large volume change for small pressure change)",
      "Serve as the body's main blood volume reservoir",
...

  {
    ...
    setup: "",
    ans: [
      { t: "Reentrant circuit around a scar (slow-conducting border zone + unidirectional block)", ok: true  },
      { t: "Enhanced automaticity of Purkinje fibers",                                              ok: false },
      { t: "Triggered activity from early afterdepolarizations",                                     ok: false },
      { t: "AV nodal reentry",                                                                        ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Torsades de pointes (polymorphic VT with twisting axis)",  ok: true  },
      { t: "Atrial fibrillation",                                        ok: false },
      { t: "Monomorphic VT",                                              ok: false },
      { t: "Ventricular fibrillation from reentry",                        ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Ohm's law applied to flow: ΔP = Q × R",                 ok: true  },
      { t: "Boyle's law for gases",                                   ok: false },
      { t: "Laplace's law for a curved surface",                      ok: false },
      { t: "Bernoulli's principle for incompressible fluids",          ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Loss of the atrial 'kick' eliminates ~30% of diastolic filling across the stenotic valve, precipitating pulmonary edema", ok: true  },
      { t: "AFib causes rapid depolarization of the SA node",                                                                          ok: false },
      { t: "AFib directly ruptures the mitral leaflets",                                                                                 ok: false },
      { t: "AFib causes AV nodal block",                                                                                                 ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "It can become turbulent, generating audible flow murmurs and increasing shear stress on the endothelium", ok: true  },
      { t: "It is always laminar in the aorta under normal conditions",                                                 ok: false },
      { t: "It is exclusively pulsatile but never turbulent",                                                              ok: false },
      { t: "It is governed by free-surface hydraulics",                                                                     ok: false },
    ],
...

  {
    ...
    ans: [
      ...
      { t: "Peripheral arteriolar vasodilation",                                                                          ok: false },
      { t: "Increased blood viscosity",                                                                                     ok: false },
      { t: "Reduced blood volume",                                                                                           ok: false },
    ],
