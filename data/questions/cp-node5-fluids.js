...
export const CP_NODE5_QUESTIONS = [
...

  {
    id: "cp-n5-005",
    type: "mcq",
    prompt: "An arterial line transducer is raised 15 cm above the phlebostatic axis. How does this affect the displayed blood pressure?",
    setup: "",
    ans: [
      { t: "The displayed pressure reads falsely LOW by approximately 11 mmHg",  ok: true  },
      { t: "The displayed pressure reads falsely HIGH by approximately 11 mmHg", ok: false },
      { t: "The displayed pressure is unaffected by transducer height changes",  ok: false },
      { t: "The arterial waveform becomes dampened but the mean pressure is correct", ok: false },
    ],
    rationale: "Raising the transducer above the patient creates a hydrostatic column that subtracts from the measured pressure. Each 1.36 cm H₂O ≈ 1 mmHg; 15 cm ÷ 1.36 ≈ 11 mmHg. The monitor reads lower than the actual pressure. Conversely, lowering the transducer adds hydrostatic pressure, producing a falsely high reading. Always zero the transducer at the phlebostatic axis (4th intercostal space, mid-axillary line).",
    scene: "pressure_depth",
...

  {
    id: "cp-n5-020",
    type: "mcq",
    prompt: "Gas flowing through an endotracheal tube encounters significant resistance. If the ETT internal diameter is reduced from 8.0 mm to 6.0 mm, by what factor does resistance increase (assuming laminar flow)?",
    setup: "Resistance ∝ 1/r⁴. Ratio of radii: (4.0/3.0)⁴.",
    ans: [
      { t: "Approximately 3.2 times — calculated as (4.0/3.0)⁴ from the inverse fourth-power radius relationship", ok: true  },
      { t: "Approximately 1.3 times — resistance increases linearly with the ratio of the two diameters",           ok: false },
      { t: "Approximately 16 times — resistance scales with the fourth power of the diameter difference itself",     ok: false },
      { t: "Approximately 2.0 times — halving the cross-sectional area exactly doubles the resistance to flow",      ok: false },
    ],
    rationale: "R ∝ 1/r⁴. Radii: 4.0 mm vs 3.0 mm. Ratio = (4.0/3.0)⁴ = (1.333)⁴ ≈ 3.16. A reduction from 8.0 to 6.0 mm ID roughly triples resistance. This explains why even a small decrease in ETT size (e.g., from swelling, secretions, or using a smaller tube) dramatically increases airway resistance and work of breathing.",
    scene: "vessel_cross_section",
    sceneCfg: { label: "SMALLER ETT = MUCH MORE RESISTANCE" },
    metadata: { topic: "Poiseuille's Law", priority: "high" },
  },
