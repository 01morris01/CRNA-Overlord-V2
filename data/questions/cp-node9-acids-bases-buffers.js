...
export const CP_NODE9_QUESTIONS = [
...

  {
    ...
    setup: "",
    ans: [
      { t: "40 nmol/L — the normal [H+] at pH 7.40", ok: true },
      { t: "40 mmol/L — hydrogen ions are present in millimolar concentrations in plasma", ok: false },
      { t: "7.4 nmol/L — [H+] equals the pH value expressed in nanomoles per liter", ok: false },
      { t: "4.0 nmol/L — [H+] is one-tenth of the pH value in nanomolar units", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "A doubling of [H+] — from ~40 nmol/L to ~80 nmol/L", ok: true },
      { t: "A 30% increase in [H+] — proportional to the 0.3 unit pH change", ok: false },
      { t: "A 10-fold increase in [H+] — each 0.1 pH unit is a full log step", ok: false },
      { t: "No significant change in [H+] — a 0.3 unit pH shift is clinically trivial", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Approximately 6.8 — the Kw of water increases with temperature, shifting the neutral pH below 7.0", ok: true },
      { t: "Exactly 7.0 — the neutral pH is always 7.0 regardless of temperature", ok: false },
      { t: "Approximately 7.4 — neutral pH equals normal blood pH at body temperature", ok: false },
      { t: "Approximately 7.8 — higher temperature raises the neutral pH above 7.0", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "A proton (H+) donor — any substance that can donate a hydrogen ion to another molecule", ok: true },
      { t: "An electron pair acceptor — any substance that accepts a lone pair from another species", ok: false },
      { t: "A substance that produces OH- ions when dissolved in water", ok: false },
      { t: "Any substance with a pH less than 7.0 in aqueous solution", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "An electron pair acceptor — it accepts a pair of electrons from another species to form a coordinate bond", ok: true },
      { t: "A proton donor — it donates hydrogen ions into solution", ok: false },
      { t: "A substance that increases [OH-] in aqueous solution", ok: false },
      { t: "Any molecule that can form hydrogen bonds with water", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "It dissociates completely in aqueous solution — virtually 100% of HCl molecules ionize to H+ and Cl-", ok: true },
      { t: "It has a very high molecular weight compared to other acids used in clinical settings", ok: false },
      { t: "It produces more heat per mole when mixed with water than any other acid", ok: false },
      { t: "It has a pKa value greater than 7, indicating strong buffering capacity at physiologic pH", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "pH = 6.1 + log([HCO3-] / [0.03 x PaCO2]) — using pKa 6.1 for carbonic acid and the solubility coefficient for CO2", ok: true },
      { t: "pH = 7.4 + log([HCO3-] / [PaCO2]) — using normal blood pH as the pKa value", ok: false },
      { t: "pH = 6.1 + log([PaCO2] / [HCO3-]) — the CO2 term is in the numerator", ok: false },
      { t: "pH = 7.1 + log([HCO3-] / [H2CO3]) — using the pKa of water at body temperature", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "7.10 — doubling PaCO2 halves the ratio, reducing pH by log(2) = 0.3 units from 7.40", ok: true },
      { t: "7.25 — the pH drops by 0.15 for each doubling of PaCO2", ok: false },
      { t: "7.00 — doubling PaCO2 causes a full 0.4 unit drop in pH", ok: false },
      { t: "7.35 — PaCO2 changes have minimal effect on pH due to buffering", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Bicarbonate buffer system (H2CO3/HCO3-) — it handles ~64% of extracellular buffering and is regulated by both lungs and kidneys", ok: true },
      { t: "Phosphate buffer system (H2PO4-/HPO4 2-) — it is the primary buffer in all body compartments", ok: false },
      { t: "Hemoglobin buffer system — it dominates extracellular buffering due to its high plasma concentration", ok: false },
      { t: "Protein buffer system — plasma proteins provide the majority of extracellular buffering capacity", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Its imidazole groups on histidine residues have a pKa near physiologic pH, and deoxygenated Hb is a better buffer than oxygenated Hb", ok: true },
      { t: "It freely dissolves in plasma at high concentrations, providing extensive extracellular buffering", ok: false },
      { t: "Its iron-containing heme groups directly neutralize hydrogen ions through redox reactions", ok: false },
      { t: "It converts CO2 to carbonic acid in plasma without enzymatic assistance", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Intracellular fluid and renal tubular fluid — where phosphate concentrations are highest", ok: true },
      { t: "Arterial blood plasma — where it maintains pH between 7.35 and 7.45", ok: false },
      { t: "Cerebrospinal fluid — where it is the sole buffer protecting the brain", ok: false },
      { t: "Interstitial fluid — where it provides the majority of extracellular buffering capacity", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Acute respiratory acidosis — the low pH and elevated PaCO2 indicate CO2 retention, with only mild HCO3- compensation", ok: true },
      { t: "Metabolic acidosis — the low pH is always caused by a metabolic process", ok: false },
      { t: "Chronic respiratory acidosis — the elevated HCO3- indicates full renal compensation", ok: false },
      { t: "Mixed respiratory and metabolic alkalosis — the HCO3- is above normal", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Acute respiratory alkalosis — the high pH and low PaCO2 with normal HCO3- indicate hyperventilation without renal compensation", ok: true },
      { t: "Metabolic alkalosis — the elevated pH is caused by excess bicarbonate", ok: false },
      { t: "Compensated metabolic acidosis — the low PaCO2 represents respiratory compensation for a metabolic disorder", ok: false },
      { t: "Mixed acid-base disorder — both PaCO2 and HCO3- are abnormal", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "The amount of strong acid or base (in mEq/L) needed to titrate blood back to pH 7.40 at PaCO2 40 mmHg and 37 degrees C", ok: true },
      { t: "The difference between measured HCO3- and the normal value of 24 mEq/L", ok: false },
      { t: "The total concentration of all buffer bases in the blood including hemoglobin and phosphate", ok: false },
      { t: "The ratio of bicarbonate to dissolved CO2 expressed as a single value", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "27 mmHg — Winter's formula: PaCO2 = (1.5 x HCO3-) + 8 (plus or minus 2) = (1.5 x 12) + 8 = 26", ok: true },
      { t: "40 mmHg — PaCO2 remains normal because the disorder is purely metabolic", ok: false },
      { t: "50 mmHg — the body retains CO2 to compensate for the low bicarbonate", ok: false },
      { t: "15 mmHg — PaCO2 should drop to match the HCO3- value", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Prolonged nasogastric suction or vomiting — loss of gastric HCl depletes H+ and Cl-, causing contraction alkalosis", ok: true },
      { t: "Excessive administration of normal saline — the high chloride content generates alkalosis", ok: false },
      { t: "Hyperventilation during mechanical ventilation — excessive CO2 removal raises HCO3-", ok: false },
      { t: "Acute kidney injury — failure to excrete bicarbonate causes retention alkalosis", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Inadequate minute ventilation — the ventilator settings are not providing enough alveolar ventilation to eliminate CO2 production", ok: true },
      { t: "Excessive sodium bicarbonate administration — exogenous HCO3- is being converted to CO2", ok: false },
      { t: "Malignant hyperthermia — although this causes rising ETCO2, it produces metabolic acidosis not respiratory acidosis", ok: false },
      { t: "Renal failure — the kidneys cannot excrete enough CO2 to maintain normal PaCO2", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "25 mEq/L — significantly elevated (normal 8-12), indicating an anion gap metabolic acidosis", ok: true },
      { t: "12 mEq/L — within normal limits, suggesting no acid-base disturbance", ok: false },
      { t: "40 mEq/L — the gap equals the sum of unmeasured cations minus unmeasured anions", ok: false },
      { t: "15 mEq/L — the anion gap equals the bicarbonate concentration", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Red blood cells — carbonic anhydrase enables rapid CO2 hydration for transport as HCO3- in venous blood", ok: true },
      { t: "Plasma — the enzyme circulates freely in blood plasma at high concentrations", ok: false },
      { t: "Hepatocytes — the liver is the primary site of CO2 conversion to bicarbonate", ok: false },
      { t: "Alveolar epithelial cells — the enzyme facilitates gas exchange at the alveolar membrane", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "It is an open system — the lungs continuously adjust CO2 and the kidneys regulate HCO3-, preventing equilibrium from being reached", ok: true },
      { t: "The pKa of bicarbonate shifts to 7.4 at body temperature due to protein interactions", ok: false },
      { t: "Carbonic acid exists at much higher concentrations than bicarbonate, providing excess buffering capacity", ok: false },
      { t: "The bicarbonate system only buffers respiratory disturbances, not metabolic ones", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Maximal respiratory compensation — the body drives down PaCO2 to partially correct the severe metabolic acidosis", ok: true },
      { t: "A primary respiratory alkalosis occurring simultaneously with the metabolic acidosis", ok: false },
      { t: "Respiratory failure caused by ketoacid damage to the brainstem respiratory center", ok: false },
      { t: "An artifact of the measurement — PaCO2 cannot drop below 25 mmHg physiologically", ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Tissue hypoperfusion — inadequate oxygen delivery forces cells into anaerobic glycolysis, producing lactate", ok: true },
      { t: "Excessive administration of lactated Ringer's solution — the exogenous lactate directly causes acidosis", ok: false },
      { t: "Hypothermia — cold temperatures increase lactate production by stimulating aerobic metabolism", ok: false },
      { t: "Hyperventilation — respiratory alkalosis triggers compensatory lactic acid production", ok: false },
    ],
