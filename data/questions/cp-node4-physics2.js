...
export const CP_NODE4_QUESTIONS = [
...

  {
    ...
    setup: "",
    ans: [
      { t: "They are inversely related, so high elastance means low compliance and the reverse is true", ok: true },
      { t: "They are directly proportional, so high elastance always accompanies high lung compliance", ok: false },
      { t: "They are unrelated, since elastance is airway resistance while compliance is the lung volume", ok: false },
      { t: "Elastance equals compliance squared, so they share an exponential not a reciprocal relation", ok: false },
    ],
