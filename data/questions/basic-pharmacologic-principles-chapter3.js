...
export const PHARM_PRINCIPLES_QUESTIONS = [
  ...
  // ── 001 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Drug dose linked to drug concentration at the action site.", ok: true },
      { t: "Drug concentration linked to the resulting physiologic effect.", ok: false },
      { t: "Receptor affinity linked to a ligand's intrinsic activity.", ok: false },
      { t: "Enzymatic destruction linked to renal tubular secretion.", ok: false },
    ],
  ...
  // ── 004 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Drug behavior right after the initial dose is given.", ok: true },
      { t: "Drug behavior during a long continuous infusion run.", ok: false },
      { t: "Drug behavior right after a long infusion is ended.", ok: false },
      { t: "Drug behavior only once steady state is reached.", ok: false },
    ],
  ...
  // ── 008 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "It is acute tolerance acquired after only a few doses.", ok: true },
      { t: "It is chronic tolerance from prolonged drug exposure.", ok: false },
      { t: "It raises the total number of available receptors.", ok: false },
      { t: "It physically destroys the targeted receptors.", ok: false },
    ],
  ...
  // ── 011 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "It blocks the receptor so high agonist levels cannot overcome it.", ok: true },
      { t: "It blocks loosely so high agonist levels easily overcome it.", ok: false },
      { t: "It permanently destroys the receptor on the cell surface.", ok: false },
      { t: "It detaches the receptor entirely from the host cell.", ok: false },
    ],
  ...
  // ── 014 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Drug input into the body equals drug loss from it.", ok: true },
      { t: "Drug input into the body exceeds drug loss from it.", ok: false },
      { t: "Free drug stays isolated to the central compartment.", ok: false },
      { t: "Free drug stays isolated to a peripheral compartment.", ok: false },
    ],
  ...
  // ── 017 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Overall extent of a drug's bioavailability by a route.", ok: true },
      { t: "Overall extent of a drug's toxicity in the brain.", ok: false },
      { t: "Overall extent of a drug's plasma protein binding.", ok: false },
      { t: "Overall extent of a drug's lipid membrane binding.", ok: false },
    ],
  ...
  // ── 023 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Concentration at the action site equals the plasma level.", ok: true },
      { t: "Concentration at the action site equals the adipose level.", ok: false },
      { t: "The drug bypasses the systemic circulation entirely.", ok: false },
      { t: "The drug binds only to peripheral plasma proteins.", ok: false },
    ],
  ...
  // ── 039 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "What the drug does to the body via concentration and effect.", ok: true },
      { t: "What the body does to the drug via uptake and removal.", ok: false },
      { t: "Exact half-life variation seen across drug families.", ok: false },
      { t: "Exact clearance capacity of the major organ systems.", ok: false },
    ],
  ...
  // ── 047 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "It inhibits acetylcholinesterase so acetylcholine can outcompete it.", ok: true },
      { t: "It activates acetylcholinesterase so acetylcholine is destroyed.", ok: false },
      { t: "It directly breaks down vecuronium molecules within plasma.", ok: false },
      { t: "It forcibly closes the postsynaptic ion channels at rest.", ok: false },
    ],
  ...
  // ── 052 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Drug behavior during an infusion and after the infusion ends.", ok: true },
      { t: "Drug behavior only in the first minutes after IV dosing.", ok: false },
      { t: "Drug behavior limited strictly to oral drug ingestion.", ok: false },
      { t: "Drug behavior occurring before the biophase delay sets in.", ok: false },
    ],
  ...
  // ── 053 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Time for concentration to fall 50 percent after a stop, set by infusion length.", ok: true },
      { t: "Fixed time for full hepatic removal of a steady-state drug from plasma.", ok: false },
      { t: "Constant time for one bolus to fall 50 percent in the plasma level.", ok: false },
      { t: "Time spent on initial receptor binding once an infusion has begun.", ok: false },
    ],
  ...
  // ── 054 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "A constant fraction of the drug clears per unit of time.", ok: true },
      { t: "A constant amount of the drug clears per unit of time.", ok: false },
      { t: "The elimination speed keeps rising as time goes on.", ok: false },
      { t: "Elimination stops entirely after the very first pass.", ok: false },
    ],
  ...
  // ── 055 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "A constant amount of the drug clears per unit of time.", ok: true },
      { t: "A constant fraction of the drug clears per unit of time.", ok: false },
      { t: "The elimination speed keeps rising as time goes on.", ok: false },
      { t: "Elimination stops entirely after the very first pass.", ok: false },
    ],
  ...
  // ── 056 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "The actual drug concentration that gets achieved.", ok: true },
      { t: "The total regional blood flow that is delivered.", ok: false },
      { t: "Nothing, since clearance ignores concentration.", ok: false },
      { t: "Only a single fixed half-life value for the drug.", ok: false },
    ],
  ...
  // ── 057 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Half-life is truly accurate only in a one-compartment model.", ok: true },
      { t: "Half-life can only measure zero-order drug elimination.", ok: false },
      { t: "Glomerular filtration completely nullifies any half-life.", ok: false },
      { t: "First-pass metabolism voids all half-life calculations.", ok: false },
    ],
