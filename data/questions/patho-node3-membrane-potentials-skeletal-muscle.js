...
export const PATHO_NODE3_QUESTIONS = [
...

  {
    ...
    ans: [
      ...
      { t: "Hyperpolarization pushes Vm below the activation threshold of Na⁺ channels",                                                 ok: false },
      { t: "Hyperkalemia directly inhibits the Na⁺/K⁺-ATPase, halting all conduction",                                                   ok: false },
      { t: "ENa shifts more positive, increasing the driving force and exhausting Na⁺ stores",                                           ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Voltage-gated Na⁺ channels open; Na⁺ permeability dominates and drives Vm toward ENa (~+60 mV)", ok: true  },
      { t: "K⁺ permeability transiently exceeds Na⁺ permeability, driving Vm toward EK",                     ok: false },
      { t: "The Na⁺/K⁺-ATPase actively transports charge to create a positive intracellular potential",      ok: false },
      { t: "Ca²⁺ entry via L-type channels during Phase 2 drives the membrane positive",                      ok: false },
    ],
...

  {
    ...
    choices: [
      ...
      "Length of thin filaments themselves",
      "Length of thick filaments themselves",
    ],
    correctAnswers: [
      "I band (thin filaments only)",
      "H zone (center of A band, thick filaments only)",
...

  {
    ...
    setup: "",
    ans: [
      { t: "Ca²⁺ released from the sarcoplasmic reticulum via ryanodine receptors",     ok: true  },
      { t: "Ca²⁺ entering through DHP receptors from ECF — the primary source in skeletal muscle", ok: false },
      { t: "Na⁺ through voltage-gated channels",                                         ok: false },
      { t: "Mg²⁺ from the sarcoplasmic reticulum",                                       ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "RMP depolarizes modestly, then more substantially as ion gradients run down", ok: true  },
      { t: "RMP hyperpolarizes immediately because K⁺ accumulates outside",                ok: false },
      { t: "No effect — the pump contributes 0% of Vm",                                    ok: false },
      { t: "RMP immediately drops to 0 mV",                                                  ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "It lasts ~0.25–0.30 sec, preventing tetanic contraction and allowing full ventricular filling",  ok: true  },
      { t: "It lasts ~2 ms, similar to a skeletal muscle fiber",                                                 ok: false },
      { t: "It is absent in cardiac muscle because of gap junctions",                                            ok: false },
      { t: "It is determined entirely by the Ca²⁺ ATPase recovery time",                                         ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Decreased excitability — the cell is farther from threshold and needs a larger depolarization to fire", ok: true  },
      { t: "Increased excitability — hyperpolarization always makes a cell easier to fire",                         ok: false },
      { t: "No effect — threshold is independent of starting Vm",                                                    ok: false },
      { t: "The cell becomes spontaneously active",                                                                   ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Gap junctions within intercalated discs",  ok: true  },
      { t: "Sarcoplasmic reticulum",                   ok: false },
      { t: "T-tubules",                                ok: false },
      { t: "Neuromuscular junctions",                  ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Phase 2 — the plateau",                   ok: true  },
      { t: "Phase 0 — the upstroke",                  ok: false },
      { t: "Phase 3 — final repolarization",          ok: false },
      { t: "Phase 4 — resting potential",             ok: false },
    ],
