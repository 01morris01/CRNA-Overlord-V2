...
export const AIRWAY_QUESTIONS = [
  ...
  // ── 010 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      ...
      { t: "Recurrent laryngeal nerve from the vagus trunk.", ok: false },
      { t: "Glossopharyngeal nerve to the posterior pharynx.", ok: false },
    ],
  ...
  // ── 020 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Unopposed adduction causing stridor and distress.", ok: true },
      { t: "Unopposed abduction causing severe aspiration risk.", ok: false },
      { t: "Completely normal respiration with mild hoarseness.", ok: false },
      { t: "A fully normal voice despite total cord paralysis.", ok: false },
    ],
  ...
  // ── 033 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "They act as macrophages in defense and inflammation.", ok: true },
      { t: "They are the cells that produce pulmonary surfactant.", ok: false },
      { t: "They form the thin structural alveolar gas barrier.", ok: false },
      { t: "They generate the complete cartilaginous airway rings.", ok: false },
    ],
  ...
  // ── 038 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Faucial pillars, uvula, and entire soft palate.", ok: true },
      { t: "Uvula and most of the soft palate, no pillars.", ok: false },
      { t: "Soft palate base and the hard palate only.", ok: false },
      { t: "Hard palate visible, soft palate hidden.", ok: false },
    ],
  ...
  // ── 039 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Uvula and most of the soft palate, no pillars.", ok: true },
      { t: "Faucial pillars, uvula, and entire soft palate.", ok: false },
      { t: "Soft palate base and the hard palate only.", ok: false },
      { t: "Hard palate visible, soft palate hidden.", ok: false },
    ],
  ...
  // ── 040 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Soft palate base and the hard palate only.", ok: true },
      { t: "Uvula and most of the soft palate, no pillars.", ok: false },
      { t: "Faucial pillars, uvula, and entire soft palate.", ok: false },
      { t: "Hard palate visible, soft palate hidden.", ok: false },
    ],
  ...
  // ── 041 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Hard palate visible, soft palate hidden.", ok: true },
      { t: "Soft palate base and the hard palate only.", ok: false },
      { t: "Uvula and most of the soft palate, no pillars.", ok: false },
      { t: "Faucial pillars, uvula, and entire soft palate.", ok: false },
    ],
  ...
  // ── 042 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Most or all of the glottic opening is seen.", ok: true },
      { t: "Only the posterior glottic opening is seen.", ok: false },
      { t: "Only the epiglottis, not the glottis.", ok: false },
      { t: "Only the soft palate, not the glottis.", ok: false },
    ],
  ...
  // ── 043 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Only the posterior glottic opening is seen.", ok: true },
      { t: "Most or all of the glottic opening is seen.", ok: false },
      { t: "Only the epiglottis, not the glottis.", ok: false },
      { t: "Only the soft palate, not the glottis.", ok: false },
    ],
  ...
  // ── 045 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Grade III, epiglottis seen but not the cords.", ok: true },
      { t: "Grade I, full glottic opening already in view.", ok: false },
      { t: "Grade IV, not even the epiglottis is visible.", ok: false },
      { t: "Never, it is unsafe for any intubation attempt.", ok: false },
    ],
  ...
  // ── 050 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Lower incisors cannot reach past the upper lip.", ok: true },
      { t: "Lower incisors bite above the upper lip border.", ok: false },
      { t: "Lower incisors bite right on the upper lip line.", ok: false },
      { t: "The patient has no lower mandibular incisors at all.", ok: false },
    ],
  ...
  // ── 057 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Evaluate using the 3-3-2 rule.", ok: true },
      { t: "Extubate the patient while awake.", ok: false },
      { t: "Escalate straight to a surgical airway.", ok: false },
      { t: "Ensure the stomach is fully emptied first.", ok: false },
    ],
  ...
  // ── 064 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "The tube tip moves toward the carina about 2 cm.", ok: true },
      { t: "The tube tip moves away from the carina about 2 cm.", ok: false },
      { t: "The tube tip slips out past the cords immediately.", ok: false },
      { t: "The tube rotates sideways within the trachea 5 cm.", ok: false },
    ],
  ...
  // ── 065 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Abdomen shifts cephalad, raising endobronchial intubation risk.", ok: true },
      { t: "Abdomen shifts toward the pelvis, preventing endobronchial tube.", ok: false },
  ...
  // ── 073 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "Clicks felt as it rides over the tracheal rings.", ok: true },
      { t: "Smooth gliding with essentially no resistance.", ok: false },
      { t: "An abrupt stop right at the soft palate level.", ok: false },
      { t: "A sudden plunge into pooled gastric fluid.", ok: false },
    ],
  ...
  // ── 080 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "They are essentially equivalent methods.", ok: true },
      { t: "Eight deep breaths are clearly superior.", ok: false },
      { t: "Three minutes of tidal breathing is better.", ok: false },
      { t: "Both are worse than four deep breaths.", ok: false },
    ],
  ...
  // ── 087 ──────────────────────────────────────────────────────────────────────
  {
    ...
    ans: [
      { t: "It blows secretions above the cuff into the pharynx.", ok: true },
      { t: "It forces all volatile anesthetic out of the lungs.", ok: false },
      { t: "It keeps the vocal cords reliably abducted open.", ok: false },
      { t: "It keeps the vocal cords reliably adducted shut.", ok: false },
    ],
