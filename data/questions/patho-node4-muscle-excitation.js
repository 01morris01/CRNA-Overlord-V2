...
export const PATHO_NODE4_QUESTIONS = [

  {
    ...
    setup: "",
    ans: [
      { t: "Opening of a non-selective cation channel — mainly Na⁺ influx depolarizes the end plate",  ok: true  },
      { t: "Opening of a K⁺-selective channel that hyperpolarizes the end plate",                      ok: false },
      { t: "Direct activation of L-type Ca²⁺ channels on the sarcolemma",                               ok: false },
      { t: "Release of Ca²⁺ from the sarcoplasmic reticulum through DHP/RyR coupling",                  ok: false },
    ],
...

  {
    ...
    ans: [
      ...
      { t: "Defective voltage-gated Ca²⁺ channels at the pre-synaptic motor terminal",                         ok: false },
      { t: "Mutation in the sarcoplasmic reticulum RyR1 channel",                                                ok: false },
      { t: "Failure of acetylcholinesterase to clear ACh from the synaptic cleft",                                ok: false },
    ],
...

  {
    ...
    setup: "",
    choices: [
      "Ca²⁺ binds calmodulin, not troponin C",
      "Calmodulin–Ca²⁺ activates myosin light chain kinase (MLCK)",
      "Has a 'latch state' that maintains tone with minimal ATP",
      "Troponin T couples Ca²⁺ release to cross-bridge activation",
      "Tetanic fusion requires MLCK phosphorylation of actin",
    ],
    correctAnswers: [
      "Ca²⁺ binds calmodulin, not troponin C",
      "Calmodulin–Ca²⁺ activates myosin light chain kinase (MLCK)",
...

  {
    ...
    setup: "",
    ans: [
      { t: "Depolarizing blockade — SCh is a nicotinic AChR agonist that persistently depolarizes the end plate, closing Na⁺ channel inactivation gates", ok: true  },
      { t: "Competitive antagonism at nicotinic AChR with no receptor activation",                                                                           ok: false },
      { t: "Irreversible inhibition of acetylcholinesterase",                                                                                                 ok: false },
      { t: "Blockade of pre-synaptic VGCCs, preventing ACh release",                                                                                          ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Direct mechanical (voltage-sensor) coupling — DHPR conformational change physically opens RyR1",  ok: true  },
      { t: "Calcium-induced calcium release — extracellular Ca²⁺ through DHPR triggers RyR1",                  ok: false },
      { t: "cAMP-mediated phosphorylation of RyR1",                                                             ok: false },
      { t: "IP₃ generation and IP₃ receptor activation on the SR",                                              ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Myosin light chain phosphatase dephosphorylates the myosin light chain",  ok: true  },
      { t: "Calcium rebinds to troponin C",                                             ok: false },
      { t: "Actin is degraded by caspases",                                             ok: false },
      { t: "Titin springs the sarcomere back to resting length",                         ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Gap junctions coupling cells so they contract synchronously, like a syncytium",   ok: true  },
      { t: "Each cell innervated by its own motor neuron, like skeletal muscle",               ok: false },
      { t: "Voluntary control via corticospinal tract",                                         ok: false },
      { t: "Striated sarcomeres in register across cells",                                      ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "NO → guanylate cyclase → cGMP → activates MLCP → dephosphorylates MLC → relaxation", ok: true  },
      { t: "NO directly blocks L-type Ca²⁺ channels in the sarcolemma",                           ok: false },
      { t: "NO activates adenylate cyclase, raising cAMP to phosphorylate MLCK",                  ok: false },
      { t: "NO causes Ca²⁺ release from SR via ryanodine receptors",                               ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "DHP receptor (voltage sensor in T-tubule) → RyR1 (Ca²⁺ release channel on SR)", ok: true  },
      { t: "IP₃ receptor → SERCA pump",                                                     ok: false },
      { t: "Nicotinic AChR → RyR2",                                                          ok: false },
      { t: "Voltage-gated Na⁺ channel → troponin C directly",                                  ok: false },
    ],
...

  {
    ...
    ans: [
      ...
      { t: "More abundant mitochondria per unit volume",                                                            ok: false },
      { t: "Faster cross-bridge cycling rate",                                                                       ok: false },
      { t: "Dependence on anaerobic glycolysis",                                                                      ok: false },
    ],
...

  {
    ...
    setup: "",
    ans: [
      { t: "Competitive antagonism of post-synaptic nicotinic AChRs — no activation, no EPP",  ok: true  },
      { t: "Persistent agonism that inactivates Na⁺ channels adjacent to the end plate",       ok: false },
      { t: "Irreversible inhibition of pre-synaptic choline reuptake",                           ok: false },
      { t: "Cleavage of synaptobrevin preventing ACh vesicle fusion",                              ok: false },
    ],
